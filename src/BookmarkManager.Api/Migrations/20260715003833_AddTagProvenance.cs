...
{
    /// <inheritdoc />
    public partial class AddTagProvenance : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagProvenances", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_TagProvenances_BookmarkId",
                table: "TagProvenances",
                column: "BookmarkId");

            migrationBuilder.CreateIndex(
                name: "IX_TagProvenances_BookmarkId_Tag",
                table: "TagProvenances",
                columns: new[] { "BookmarkId", "Tag" });
        }
